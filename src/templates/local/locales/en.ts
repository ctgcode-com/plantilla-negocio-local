...
export const dataEn: LocalData = {
  ...
  about: {
    ...
    imageAlt: 'Restaurant dining room with wooden tables and upholstered benches',
    highlights: [
  ...
  gallery: {
    ...
    images: [
      { src: '/images/galeria-pizza-artesanal.avif', alt: 'Freshly baked artisan pizza on a wooden board', span: 'tall' },
      { src: '/images/galeria-bowl-ensalada.avif', alt: 'Salad bowl with chicken, corn, tomato and fresh vegetables' },
      { src: '/images/galeria-terraza-atardecer.avif', alt: 'Waterfront restaurant terrace at sunset' },
      { src: '/images/galeria-comedor-barra.avif', alt: 'Main dining room with the bar in the background', span: 'wide' },
      { src: '/images/galeria-salon-mesas.avif', alt: 'Dining room with wooden tables and hanging lamps' },
      { src: '/images/galeria-desayuno-pancakes.avif', alt: 'Stack of pancakes with maple syrup and banana' },
    ],
  },
  hours: {
    title: 'Opening Hours',
